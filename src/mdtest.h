...
typedef enum {
  ...
  MDTEST_FILE_SYMLINK_NUM = 8,
  MDTEST_FILE_READLINK_NUM = 9,
  MDTEST_FILE_UNLINK_NUM = 10,
  MDTEST_FILE_TRUNCATE_NUM = 11,
  MDTEST_FILE_RENAME_NUM = 12,
  MDTEST_FILE_REMOVE_NUM = 13,
  MDTEST_TREE_CREATE_NUM = 14,
  MDTEST_TREE_REMOVE_NUM = 15,
  MDTEST_LAST_NUM
} mdtest_test_num_t;
